...
with st.expander("❗❗ 글상자를 펼쳐 사용방법을 읽어보세요 👆✅", expanded=False):
    st.markdown(
        ...
        **3️⃣ 재생 막대의 버튼으로 ▶ 재생 및 ⏸ 정지,**  
        &nbsp;&nbsp;&nbsp;잉글링의 말이 빠르다면 재생 막대의 오른쪽 점 세 개(⋮) 버튼을 눌러 속도를 조절하기.  
        **4️⃣ 1~3번을 반복하기.**  
        말문이 막히면 [잠깐 멈춤] 버튼을 누르고 생각한 후 [녹음 시작] 버튼을 다시 눌러 말하기.
        """,
    ...
    st.subheader("🗣️ 잉글링과 이렇게 대화해 보세요!")
    st.markdown(
        """
    ...
    st.write(", ".join(character_names))  # 가로 정렬로 표시
