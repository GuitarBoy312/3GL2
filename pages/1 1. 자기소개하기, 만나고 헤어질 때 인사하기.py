...
with st.expander("❗❗ 글상자를 펼쳐 사용방법을 읽어보세요 👆✅", expanded=False):
    ...
    3️⃣ 재생 막대의 버튼으로 재생▶ 및 정지⏸,<br>
       잉글링의 말이 빠르다면 재생 막대의 오른쪽 스노우맨 버튼(점 세개)을 눌러 재생 속도를 조절하기.<br> 
    4️⃣ 1~3번을 반복하기. 말문이 막힐 땐 [잠깐 멈춤] 버튼을 누르고 할말을 생각한 후 [녹음 시작] 버튼을 다시 눌러 말하기.<br>
    <br>
    ...
    st.divider()
    st.write("다음 보기와 같이 잉글링과 대화를 해 보세요.")
    st.markdown('''
